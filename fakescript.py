...
if __name__ == '__main__':
    ...
    print("Opening main window0...")
    print("Opening main window1...")
    print("Opening main window2...")
    print("Opening main window3...")
    print("Opening main window4...")
    print("Opening main window5...")
